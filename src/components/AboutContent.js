...
const AboutContent = () => {
  return (
    <div className="about">
        <div className="left">
            <h1>Who am I?</h1>
            <p>My name is Parker and I am an aspiring Full Stack Developer.  I was born and raised in San Diego, CA, living there until 2016 which was when I then made the move up north to attend San Jose State University. While there, I graduated with my Bachelor's in Entrepreneurship as well as made San Jose my new home. </p>
